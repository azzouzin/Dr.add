                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ClipOval(
                                        child: Container(
                                          color: clinicclr.withOpacity(0.5),
                                          width: 40,
                                          height: 40,
        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20), color: clinicclr),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  Text(
  ...
  Widget buttoon(witdh, height) {
    return InkWell(
        ...
        child: Container(
          ...
          width: witdh * 0.85,
          decoration: BoxDecoration(
              color: clinicclr, borderRadius: BorderRadius.circular(10)),
          child: const Center(
            child:
                      ...
                      child: Text(
                        index == 0
                            ...
                            : index == 1
                                ...
                                : '10-11',
                        style: TextStyle(
                          color: clrs1[index] == gry ? clinicclr : Colors.white,
                          fontSize: witdh * 0.04,
                        ),
                      ),
                    ),
                      ...
                      child: Text(
                        index == 0
                            ...
                            : index == 1
                                ...
                                : '14-15',
                        style: TextStyle(
                          color: clrs2[index] == gry ? clinicclr : Colors.white,
                          fontSize: witdh * 0.04,
                        ),
                      ),
                    ),
                      ...
                      child: Text(
                        index == 0
                            ...
                            : index == 1
                                ...
                                : '17-18',
                        style: TextStyle(
                          color: clrs3[index] == gry ? clinicclr : Colors.white,
                          fontSize: witdh * 0.04,
                        ),
                      ),
                    ),
