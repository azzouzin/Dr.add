...
class ResetPasswordScreen extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Please entre new password the two fields must be the same',
                    ...
                    My_Text_Field(screenheight * 0.06, screenwitdh * 0.8,
                        editingController1, 'New Password'),
                    SizedBox(
                      height: screenheight * 0.05,
                    ),
                    My_Text_Field(screenheight * 0.06, screenwitdh * 0.8,
                        editingController2, 'Confirm Password'),
                    SizedBox(
                      height: screenheight * 0.05,
                    ),
                    My_Button(
                      ...
                      onprsd: () async {
                        ...
                        if (editingController1.text ==
                          ...
                          await emailController
                              .resetPassword(editingController1.text);
                        } else {
  ...
  Widget My_Text_Field(double height, double witdh,
